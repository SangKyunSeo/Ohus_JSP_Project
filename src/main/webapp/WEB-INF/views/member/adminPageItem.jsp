	...
	<div class="page-main">
		...
		<div class="admin-item-submit">
			...
			<div class="align-center">
				<button class="list-btn ad-regi" type="button"  onclick="location.href='${pageContext.request.contextPath}/item/writeForm.do'">
					상품 등록
				</button>
				<button class="list-btn ad-list" type="button"  onclick="location.href='adminPageItem.do'">
					상품 목록
				</button>
			...
			<c:if test="${count > 0}">
				<table id="ad_table">
					...
					<c:forEach var = "item" items = "${list}">
						<tr>
							<td>${item.item_num}</td>
							<td><a href = "${pageContext.request.contextPath}/item/modifyForm.do?item_num=${item.item_num}">${item.item_name}</a></td>
